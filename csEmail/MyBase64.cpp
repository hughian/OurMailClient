...
{
	const char EncodeTable[] = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/";//编码表

	string returnEncode;//返回值
...
// 概述：解码base64编码的字节串
// 输入：Data是待解码的字节串， DataByte是Data中要解码的长度
// 输出：OutByte是解码后的字节串长度， strDecode解码后的字节串
